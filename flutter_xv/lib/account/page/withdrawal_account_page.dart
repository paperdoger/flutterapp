...
import 'package:flutter_xv/account/models/withdrawal_account_model.dart';
import 'package:flutter_xv/account/widgets/withdrawal_account_item.dart';
...
class _WithdrawalAccountPageState extends State<WithdrawalAccountPage> {
  ...
  void initState() {
    ...
    _list.add(WithdrawalAccountModel('汪*', '工商银行', 0, '**** **** **** 5236'));
    _list.add(WithdrawalAccountModel('汪*', '渤海银行', 0, '**** **** **** 2165'));
  }
