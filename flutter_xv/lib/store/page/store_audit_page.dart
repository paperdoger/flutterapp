...
import 'package:flutter_xv/store/store_router.dart';
import 'package:flutter_xv/util/other_utils.dart';
import 'package:flutter_xv/util/theme_utils.dart';
import 'package:flutter_xv/widgets/my_app_bar.dart';
import 'package:flutter_xv/widgets/my_button.dart';
import 'package:flutter_xv/widgets/my_scroll_view.dart';
import 'package:flutter_xv/widgets/selected_image.dart';
import 'package:flutter_xv/widgets/selected_item.dart';
import 'package:flutter_xv/widgets/text_field_item.dart';
...
class _StoreAuditPageState extends State<StoreAuditPage> {
  ...
  String _address = '云南省 昆明市 呈贡区 高新六路201号';
